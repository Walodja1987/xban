...
// Must match XBAN._XNS (mainnet). Constructor registers `xban.xns` against this address.
...
export default async function main(hre: HardhatRuntimeEnvironment) {
  ...
  // Query the live `xns` namespace price so the constructor can register `xban.xns`.
  ...
  console.log(
    `XNS name fee for xban.xns: ${GREEN}${hre.ethers.formatEther(xnsNameFee)}${RESET} ETH\n`,
  );
